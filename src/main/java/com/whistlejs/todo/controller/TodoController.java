...
public class TodoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<TodoEntity> updateById(@PathVariable Long id, @RequestBody TodoEntity todo) {
        return new ResponseEntity<TodoEntity>(service.updateById(id, todo), HttpStatus.OK);
    }
